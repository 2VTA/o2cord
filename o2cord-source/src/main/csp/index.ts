...
export const CspPolicies: PolicyMap = {
    ...
    "cdn.discordapp.com": ImageAndCssSrc, // Discord CDN, used by o2cord and some themes to load media
    "media.discordapp.net": ImageSrc, // Discord media CDN, possible alternative to Discord CDN

    // CDNs used for some o2cord features.
...
const patchCsp = (headers: PolicyMap) => {
    ...
    if (header) {
        ...
        // we could make unsafe-inline safe by using strict-dynamic with a random nonce on our loader script https://content-security-policy.com/strict-dynamic/
