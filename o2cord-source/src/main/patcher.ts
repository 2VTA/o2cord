...
if (!IS_VANILLA) {
    ...
    process.env.DATA_DIR = join(app.getPath("userData"), "..", "o2cord");
    ...
    console.log("[o2cord] Running in vanilla mode. Not loading o2cord");
}

console.log("[o2cord] Loading original Discord app.asar");
