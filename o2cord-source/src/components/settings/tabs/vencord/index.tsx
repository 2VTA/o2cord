...
import { ConfirmModal, Forms, openModal, React, showToast, Toasts } from "@webpack/common";

import { MacOSVibrancySettings } from "./MacVibrancySettings";
import { NotificationSection } from "./NotificationSettings";
import o2BreadImage from "./o2BreadImage";
import { WindowsMaterialSettings } from "./WindowsMaterialSettings";

const O2_DEV_NAME = "! Ryder";
...
function O2DevIcon({ className }: { className?: string; }) {
    return <img className={className} src={o2BreadImage} alt="" />;
}
            ...
            <section>
                ...
                <QuickActionCard>
                    ...
                    <QuickAction
                        Icon={O2DevIcon}
                        text={
                            <span className="vc-o2-dev-action-content">
                                dev
                                <span className="vc-o2-dev-action-tag">tag</span>
                            </span>
                        }
                        action={() => showToast(O2_DEV_NAME, Toasts.Type.MESSAGE)}
                    />
                </QuickActionCard>
            </section>
...
export default wrapTab(VencordSettings, "o2cord Settings");
