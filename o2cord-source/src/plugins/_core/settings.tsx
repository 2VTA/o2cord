...
const settings = definePluginSettings({
    settingsLocation: {
        ...
        description: "Where to put the o2cord settings section",
        options: [
    ...
    includeVencordInfoWhenCopying: {
        ...
        description: "Also copy o2cord info (o2cord, Electron, Chromium) when clicking the version info in the bottom left area of the Settings page",
        default: true
    }
});
...
export default definePlugin({
    ...
    buildLayout(originalLayoutBuilder: SettingsLayoutBuilder) {
        ...
        if (layout.some(s => s?.key === "o2cord_section")) return layout;

        const { buildEntry } = this;

        const o2cordEntries: SettingsLayoutNode[] = [
            buildEntry({
                key: "o2cord_main",
                title: "o2cord",
                panelTitle: "o2cord Settings",
            ...
            isDebugOwner() && buildEntry({
                ...
                title: "debug o2",
                panelTitle: "debug o2",
                Component: DebugO2Tab,
                Icon: MainSettingsIcon
            }),
            !IS_STANDALONE && PatchHelperTab && buildEntry({
                key: "o2cord_patch_helper",
                title: "Patch Helper",
            ...
            ...this.customSections.map((func, i) => {
                ...
                return buildEntry({
                    key: `o2cord_deprecated_custom_${section}`,
                    title: label,
                    Component: element,
        ...
        const o2cordSection: SettingsLayoutNode = {
            key: "o2cord_section",
            type: LayoutTypes.SECTION,
            useTitle: () => "o2cord Settings",
            buildLayout: () => o2cordEntries
        };
        ...
        layout.splice(idx, 0, o2cordSection);
