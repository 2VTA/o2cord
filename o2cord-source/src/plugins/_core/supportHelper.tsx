...
function DevBuildConfirmModal(props: RenderModalProps) {
    ...
    return (
        ...
        >
            <div>
                <Forms.FormText>You are using a custom build of o2cord.</Forms.FormText>

                <Forms.FormText className={Margins.top8}>
                    Use your trusted o2cord build and contact your maintainer for help.
                </Forms.FormText>
        ...
        async CHANNEL_SELECT({ channelId }) {
            ...
            if (!IS_UPDATER_DISABLED) {
                ...
                if (isOutdated) {
                    openModal(props => (
                        ...
                        >
                            <div>
                                <Forms.FormText>You are using an outdated version of o2cord. Chances are, your issue is already fixed.</Forms.FormText>
                                <Forms.FormText className={Margins.top8}>
            ...
            if (!IS_WEB && IS_UPDATER_DISABLED) {
                openModal(props => (
                    ...
                    >
                        <div>
                            <Forms.FormText>You are using an externally updated o2cord version.</Forms.FormText>
                            <Forms.FormText className={Margins.top8}>
                                Contact your package maintainer for support.
                            </Forms.FormText>
                        </div>
                    </ConfirmModal>
                ));
