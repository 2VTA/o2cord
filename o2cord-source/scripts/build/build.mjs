...
const o2cordGlobalAlias = "globalThis.O2cord=globalThis.Vencord;";
...
const buildConfigs = ([
    ...
    },
    {
        ...
        format: "iife",
        target: ["esnext"],
        footer: { js: `${o2cordGlobalAlias}\n//# sourceURL=file:///O2cordRenderer\n` + sourceMapFooter("renderer") },
        globalName: "Vencord",
        sourcemap,
        plugins: [
    ...
    },
    {
        ...
        format: "iife",
        target: ["esnext"],
        footer: { js: `${o2cordGlobalAlias}\n//# sourceURL=file:///O2cordDesktopRenderer\n` + sourceMapFooter("vencordDesktopRenderer") },
        globalName: "Vencord",
        sourcemap,
        plugins: [
            globPlugins("vesktop"),
